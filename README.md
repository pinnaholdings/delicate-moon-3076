...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/delicate-moon-3076
```

A live public deployment of this template is available at [https://delicate-moon-3076.templates.workers.dev](https://delicate-moon-3076.templates.workers.dev)
